...
const Signup = () => {
  ...
  return (
    <div className="w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
      ...
      <h2 className="text-center text-2xl font-semibold mt-6">Sign Up</h2>
      <p className="text-xs text-gray-500 dark:text-gray-400">
        Create a new account to access your personalized URL shortener.
      </p>
      ...
      <form className="mt-6">
        {/* <div>
          <label
            htmlFor="username"
            className="block text-sm text-gray-800 dark:text-gray-200 text-left"
          >
            Username{' '}
            <input
              type="text"
